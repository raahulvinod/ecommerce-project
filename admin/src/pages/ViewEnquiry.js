...
const ViewEnquiry = () => {
  ...
  const { enqName, enqEmail, enqMobile, enqStatus, enqComment } = enqState;
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center">
        <h3 className="mb-3 title">View Enquiry</h3>
        <button
          className="bg-transparent border-0 fs-5 mb-0 align-items-center gap-1"
          onClick={goBack}
        >
      ...
      <div className="mt-5 bg-white p-4 d-flex flex-column gap-3 rounded-3">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            <select
              name=""
              defaultValue={enqStatus ? enqStatus : 'Change'}
